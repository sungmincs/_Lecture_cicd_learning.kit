...
**6.2~6.8 전체 — [학습자 직접] / [AI 프롬프트] 레이블 추가**
- kubectl/argocd CLI 명령, cp, git push → [학습자 직접]
- /etc/hosts 파일 편집 (6.3 Step 2) → [AI 프롬프트]
- 대부분 kubectl 직접 명령 위주라 [AI 프롬프트]는 6.3 Step 2 단 1개
