...
**8.2~8.9 — [학습자 직접] / [AI 프롬프트] 레이블 추가**
- kubectl, git push, Jenkins/GitLab UI 조작 → [학습자 직접]
- YAML/Groovy 플레이스홀더 수정 (8.4 Step 2, 8.5 Step 2/4, 8.6 Step 2) → [AI 프롬프트]
- 배포 패턴 개념 이해 (8.3 Step 1) → [AI 프롬프트]
- 8.7~8.9: 플레이스홀더 수정 Step 없어 전부 [학습자 직접]
