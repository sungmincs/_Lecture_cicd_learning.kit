# GUARDRAIL: 9.9 [GitLab] Full CI/CD workflow (Argo CD)
...
- 명령어: `cp ~/_Lecture_cicd_learning.kit/ch9/9.9/1.full-cicd-workflow.yml .gitlab-ci.yml`
