pipeline {
    ...
    stages {
        ...
        stage('Security Scan') {
            steps {
                ...
                '''
                sh '''
                    curl -sSfL https://github.com/gitleaks/gitleaks/releases/latest/download/gitleaks_$(uname -s)_x64.tar.gz | tar -xz -C /tmp/
    ...
    post {
        ...
        success {
            echo "Pipeline with Trivy scan completed — Env: ${env.TARGET_ENV}, Tag: ${env.IMAGE_TAG}"
        }
        failure {
